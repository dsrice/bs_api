...
type Token struct {
	...
	CreateUser   null.Int    `boil:"create_user" json:"create_user,omitempty" toml:"create_user" yaml:"create_user,omitempty"`
	UpdatedAt    null.Time   `boil:"updated_at" json:"updated_at,omitempty" toml:"updated_at" yaml:"updated_at,omitempty"`
	UpdatedUser  null.Int    `boil:"updated_user" json:"updated_user,omitempty" toml:"updated_user" yaml:"updated_user,omitempty"`
	DeletedFLG   null.Bool   `boil:"deleted_flg" json:"deleted_flg,omitempty" toml:"deleted_flg" yaml:"deleted_flg,omitempty"`
	DeletedAt    null.Time   `boil:"deleted_at" json:"deleted_at,omitempty" toml:"deleted_at" yaml:"deleted_at,omitempty"`
	DeletedUser  null.Int    `boil:"deleted_user" json:"deleted_user,omitempty" toml:"deleted_user" yaml:"deleted_user,omitempty"`
...
var TokenWhere = struct {
	...
	CreateUser   whereHelpernull_Int
	UpdatedAt    whereHelpernull_Time
	UpdatedUser  whereHelpernull_Int
	DeletedFLG   whereHelpernull_Bool
	DeletedAt    whereHelpernull_Time
	DeletedUser  whereHelpernull_Int
}{
	ID:           whereHelperint{field: "`tokens`.`id`"},
	UserID:       whereHelperint{field: "`tokens`.`user_id`"},
	Token:        whereHelpernull_String{field: "`tokens`.`token`"},
	RefreshToken: whereHelpernull_String{field: "`tokens`.`refresh_token`"},
	CreatedAt:    whereHelpertime_Time{field: "`tokens`.`created_at`"},
	CreateUser:   whereHelpernull_Int{field: "`tokens`.`create_user`"},
	UpdatedAt:    whereHelpernull_Time{field: "`tokens`.`updated_at`"},
	UpdatedUser:  whereHelpernull_Int{field: "`tokens`.`updated_user`"},
	DeletedFLG:   whereHelpernull_Bool{field: "`tokens`.`deleted_flg`"},
	DeletedAt:    whereHelpernull_Time{field: "`tokens`.`deleted_at`"},
	DeletedUser:  whereHelpernull_Int{field: "`tokens`.`deleted_user`"},
}
...
var (
	tokenAllColumns            = []string{"id", "user_id", "token", "refresh_token", "created_at", "create_user", "updated_at", "updated_user", "deleted_flg", "deleted_at", "deleted_user"}
	tokenColumnsWithoutDefault = []string{"id", "user_id", "token", "refresh_token", "create_user", "updated_at", "updated_user", "deleted_flg", "deleted_at", "deleted_user"}
