...
var UserWhere = struct {
	...
	CreateUser:  whereHelpernull_Int{field: "`users`.`create_user`"},
	UpdatedAt:   whereHelpernull_Time{field: "`users`.`updated_at`"},
	UpdatedUser: whereHelpernull_Int{field: "`users`.`updated_user`"},
	DeletedFLG:  whereHelpernull_Bool{field: "`users`.`deleted_flg`"},
	DeletedAt:   whereHelpernull_Time{field: "`users`.`deleted_at`"},
	DeletedUser: whereHelpernull_Int{field: "`users`.`deleted_user`"},
}
...
var (
	userAllColumns            = []string{"id", "login_id", "name", "password", "mail", "created_at", "create_user", "updated_at", "updated_user", "deleted_flg", "deleted_at", "deleted_user"}
	userColumnsWithoutDefault = []string{"id", "login_id", "name", "password", "mail", "create_user", "updated_at", "updated_user", "deleted_flg", "deleted_at", "deleted_user"}
...
func (userL) LoadTokens(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(qm.From(`tokens`), qm.WhereIn(`tokens.user_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
