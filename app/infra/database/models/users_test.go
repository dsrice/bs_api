...
var (
	userDBTypes = map[string]string{`ID`: `int`, `LoginID`: `varchar`, `Name`: `varchar`, `Password`: `varchar`, `Mail`: `varchar`, `CreatedAt`: `timestamp`, `CreateUser`: `int`, `UpdatedAt`: `timestamp`, `UpdatedUser`: `int`, `DeletedFLG`: `tinyint`, `DeletedAt`: `timestamp`, `DeletedUser`: `int`}
	_           = bytes.MinRead
)
