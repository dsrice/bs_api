...
var (
	tokenDBTypes = map[string]string{`ID`: `int`, `UserID`: `int`, `Token`: `varchar`, `RefreshToken`: `varchar`, `CreatedAt`: `timestamp`, `CreateUser`: `int`, `UpdatedAt`: `timestamp`, `UpdatedUser`: `int`, `DeletedFLG`: `tinyint`, `DeletedAt`: `timestamp`, `DeletedUser`: `int`}
	_            = bytes.MinRead
)
